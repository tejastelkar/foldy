...
struct OnboardingView: View {
    ...
    private var message: String {
        [
            "LidBend reads your MacBook hinge and makes the desktop tilt, blur, and settle as you lower the lid.",
            "Screen Recording lets LidBend render the desktop into the fold effect. Frames stay in memory, are never saved, and never leave your Mac.",
